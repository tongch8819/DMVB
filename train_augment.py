...
import time
import json
# from deep_bisim4control import dmc2gym
import dmc2gym
...
from BSIBO.agent import BisimAgent, BisimMultiViewAgent 
...
def parse_args():
    ...
    # train
    parser.add_argument('--agent', default='bmv', type=str, choices=['bmv', 'bisim'])
    ...
    # encoder/decoder
    parser.add_argument('--encoder_type', default='pixel_augment', type=str, choices=['pixel', 'pixelCarla096', 'pixelCarla098', 'identity'])
